...
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <p>Na plataforma GymUp, combinamos ciência do exercício, nutrição e mentalidade vencedora para ajudar você a alcançar
        resultados extraordinários.</p>
      <div class="cta-buttons">
        <button class="btn btn-primary">Comece Agora</button>
        <button class="btn btn-secondary">Conheça Nossos Planos</button>
      </div>
    </div>
  </section>
          ...
          <ul class="card-list swiper-wrapper">
            <li class="card-item swiper-slide">
              <a href="#" class="card-link">
                ...
                <h2 class="card-title">
                  Criar o hábito de treinar regularmente, melhorar o condicionamento físico, aprender a executar os exercícios corretamente. 
                </h2>
            ...
            <li class="card-item swiper-slide">
              <a href="#" class="card-link">
                ...
                <h2 class="card-title">
                  Aumentar a força e resistência muscular, melhorar a postura e estabilidade corporal, desenvolver grupos musculares específicos. 
                </h2>
                <button class="card-button">
                  <i class="fa-solid fa-arrow-right"></i>
                </button>
            ...
            <li class="card-item swiper-slide">
              <a href="#" class="card-link">
                ...
                <h2 class="card-title">
                  Reduzir percentual de gordura corporal, aumentar o gasto calórico diário, melhorar a resistência cardiovascular. 
                </h2>
                <button class="card-button">
                  <i class="fa-solid fa-arrow-right"></i>
                </button>
            ...
            <li class="card-item swiper-slide">
              <a href="#" class="card-link">
                ...
                <h2 class="card-title">
                  Aumentar resistência aeróbica, melhorar o desempenho em treinos funcionais ou de alta intensidade e aumentar a mobilidade
                </h2>
                <button class="card-button">
                  <i class="fa-solid fa-arrow-right"></i>
                </button>
            ...
            <li class="card-item swiper-slide">
              <a href="#" class="card-link">
                ...
                <h2 class="card-title">
                  Reduzir dores musculares e melhorar a postura, aumentar a qualidade do sono e disposição diária, desenvolver uma rotina de treinos equilibrada.</h2>
                <button class="card-button">
                  <i class="fa-solid fa-arrow-right"></i>
                </button>
              </a>
  ...
  <section class="plans animationTarget">
    <div class="section-header">
      <h2>Nossos Planos</h2>
      <p>Escolha o plano ideal para atingir seus objetivos com flexibilidade e economia.</p>
    </div>
    <div class="plans-grid">
      <div class="plan-card">
        ...
        <ul>
          ...
          <li>1 avaliação física por mês</li>
